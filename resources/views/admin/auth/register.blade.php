        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="right-login-sec-fix">
                    <h4>Sign Up</h4>
                    <form class="login-form-fix" method="post" action="{{ route('admin.register')}}">
                        @csrf
                        ...
                        <div class="dont-account text-center">
                            <p>already have an account? <a href="{{ route('admin.login-view')}}">Login!</a></p>
                        </div>
                        <div class="sign-up-sec">
                            <span>Sign Up with</span>
                            <a href="{{ route('google.login')}}" class="google-signup-btn btn btn-block"><img src="{{ asset('assets/admin/img/home/google.svg')}}"> &nbsp; Google</a>
                        </div>
                    </form>
                </div>
            </div>
